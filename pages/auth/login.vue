<template>
  <div class="min-h-screen flex items-center justify-center bg-gray-100 dark:bg-gray-900">
    <div class="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-md w-full max-w-md">
      <h1 class="text-2xl font-bold text-center text-gray-700 dark:text-gray-200 mb-6">Iniciar Sesión</h1>
...
export default defineComponent({
  ...
  setup() {
    ...
    return {
      ...
      password,
      handleLogin,
      authStore // Exponer el store para acceder a 'loading' y 'error' en el template
    };
  }
});
</script>
