...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_Icon = __nuxt_component_0;
      _push(`<!--[--><div class="container mx-auto p-4" data-v-2ec124f3><h1 class="text-2xl font-bold mb-4 text-gray-800 dark:text-gray-100" data-v-2ec124f3> Panel de Control </h1><p class="mb-6 text-gray-600 dark:text-gray-400" data-v-2ec124f3> En este panel puedes gestionar las entidades principales de la aplicaci\xF3n. </p><section class="mb-8" data-v-2ec124f3><div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-4 mb-4" data-v-2ec124f3><h2 class="text-lg font-semibold mb-4 text-gray-700 dark:text-gray-200 flex items-center" data-v-2ec124f3>`);
      _push(ssrRenderComponent(_component_Icon, {
        name: "mdi:lightning-bolt",
        class: "mr-2 text-yellow-500"
      }, null, _parent));
      _push(` Accesos Directos </h2><div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-3" data-v-2ec124f3><button class="flex flex-col items-center justify-center p-4 bg-gradient-to-br from-indigo-50 to-indigo-100 dark:from-indigo-900/30 dark:to-indigo-800/30 rounded-lg hover:shadow-md transition duration-150 ease-in-out group" data-v-2ec124f3><div class="w-12 h-12 rounded-full bg-indigo-100 dark:bg-indigo-900/50 flex items-center justify-center mb-2 group-hover:bg-indigo-200 dark:group-hover:bg-indigo-800/50 transition-colors" data-v-2ec124f3>`);
      _push(ssrRenderComponent(_component_Icon, {
        name: "mdi:source-branch-plus",
        class: "text-indigo-600 dark:text-indigo-400 text-2xl"
      }, null, _parent));
      _push(`</div><span class="text-sm font-medium text-gray-700 dark:text-gray-300 group-hover:text-indigo-700 dark:group-hover:text-indigo-300 transition-colors" data-v-2ec124f3>Sucursal</span></button><button class="flex flex-col items-center justify-center p-4 bg-gradient-to-br from-amber-50 to-amber-100 dark:from-amber-900/30 dark:to-amber-800/30 rounded-lg hover:shadow-md transition duration-150 ease-in-out group" data-v-2ec124f3><div class="w-12 h-12 rounded-full bg-amber-100 dark:bg-amber-900/50 flex items-center justify-center mb-2 group-hover:bg-amber-200 dark:group-hover:bg-amber-800/50 transition-colors" data-v-2ec124f3>`);
      _push(ssrRenderComponent(_component_Icon, {
        name: "mdi:map-marker-plus-outline",
        class: "text-amber-600 dark:text-amber-400 text-2xl"
      }, null, _parent));
      _push(`</div><span class="text-sm font-medium text-gray-700 dark:text-gray-300 group-hover:text-amber-700 dark:group-hover:text-amber-300 transition-colors" data-v-2ec124f3>Zona</span></button><button class="flex flex-col items-center justify-center p-4 bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/30 dark:to-blue-800/30 rounded-lg hover:shadow-md transition duration-150 ease-in-out group" data-v-2ec124f3><div class="w-12 h-12 rounded-full bg-blue-100 dark:bg-blue-900/50 flex items-center justify-center mb-2 group-hover:bg-blue-200 dark:group-hover:bg-blue-800/50 transition-colors" data-v-2ec124f3>`);
      _push(ssrRenderComponent(_component_Icon, {
        name: "mdi:fish",
        class: "text-blue-600 dark:text-blue-400 text-2xl"
      }, null, _parent));
      _push(`</div><span class="text-sm font-medium text-gray-700 dark:text-gray-300 group-hover:text-blue-700 dark:group-hover:text-blue-300 transition-colors" data-v-2ec124f3>Estanque</span></button><button class="flex flex-col items-center justify-center p-4 bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-900/30 dark:to-purple-800/30 rounded-lg hover:shadow-md transition duration-150 ease-in-out group" data-v-2ec124f3><div class="w-12 h-12 rounded-full bg-purple-100 dark:bg-purple-900/50 flex items-center justify-center mb-2 group-hover:bg-purple-200 dark:group-hover:bg-purple-800/50 transition-colors" data-v-2ec124f3>`);
      _push(ssrRenderComponent(_component_Icon, {
        name: "mdi:cctv",
        class: "text-purple-600 dark:text-purple-400 text-2xl"
      }, null, _parent));
      _push(`</div><span class="text-sm font-medium text-gray-700 dark:text-gray-300 group-hover:text-purple-700 dark:group-hover:text-purple-300 transition-colors" data-v-2ec124f3>C\xE1mara</span></button><button class="flex flex-col items-center justify-center p-4 bg-gradient-to-br from-lime-50 to-lime-100 dark:from-lime-900/30 dark:to-lime-800/30 rounded-lg hover:shadow-md transition duration-150 ease-in-out group" data-v-2ec124f3><div class="w-12 h-12 rounded-full bg-lime-100 dark:bg-lime-900/50 flex items-center justify-center mb-2 group-hover:bg-lime-200 dark:group-hover:bg-lime-800/50 transition-colors" data-v-2ec124f3>`);
      _push(ssrRenderComponent(_component_Icon, {
        name: "mdi:resistor-nodes",
        class: "text-lime-600 dark:text-lime-400 text-2xl"
      }, null, _parent));
      _push(`</div><span class="text-sm font-medium text-gray-700 dark:text-gray-300 group-hover:text-lime-700 dark:group-hover:text-lime-300 transition-colors" data-v-2ec124f3>Sensor</span></button><button class="flex flex-col items-center justify-center p-4 bg-gradient-to-br from-sky-50 to-sky-100 dark:from-sky-900/30 dark:to-sky-800/30 rounded-lg hover:shadow-md transition duration-150 ease-in-out group" data-v-2ec124f3><div class="w-12 h-12 rounded-full bg-sky-100 dark:bg-sky-900/50 flex items-center justify-center mb-2 group-hover:bg-sky-200 dark:group-hover:bg-sky-800/50 transition-colors" data-v-2ec124f3>`);
      _push(ssrRenderComponent(_component_Icon, {
        name: "mdi:camera-plus-outline",
        class: "text-sky-600 dark:text-sky-400 text-2xl"
      }, null, _parent));
      _push(`</div><span class="text-sm font-medium text-gray-700 dark:text-gray-300 group-hover:text-sky-700 dark:group-hover:text-sky-300 transition-colors" data-v-2ec124f3>Tipo C\xE1mara</span></button><button class="flex flex-col items-center justify-center p-4 bg-gradient-to-br from-teal-50 to-teal-100 dark:from-teal-900/30 dark:to-teal-800/30 rounded-lg hover:shadow-md transition duration-150 ease-in-out group" data-v-2ec124f3><div class="w-12 h-12 rounded-full bg-teal-100 dark:bg-teal-900/50 flex items-center justify-center mb-2 group-hover:bg-teal-200 dark:group-hover:bg-teal-800/50 transition-colors" data-v-2ec124f3>`);
      _push(ssrRenderComponent(_component_Icon, {
        name: "mdi:leak",
        class: "text-teal-600 dark:text-teal-400 text-2xl"
      }, null, _parent));
      _push(`</div><span class="text-sm font-medium text-gray-700 dark:text-gray-300 group-hover:text-teal-700 dark:group-hover:text-teal-300 transition-colors" data-v-2ec124f3>Tipo Sensor</span></button></div></div></section><div class="mb-6 flex flex-wrap gap-2" data-v-2ec124f3><button class="${ssrRenderClass([{
      ...
      }, "px-4 py-2 rounded-md text-sm font-medium transition-colors"])}" data-v-2ec124f3>`);
      _push(ssrRenderComponent(_component_Icon, {
      ...
      _push(` Usuarios </button></div><div class="grid grid-cols-1 lg:grid-cols-2 gap-6 auto-rows-fr" data-v-2ec124f3>`);
...
const controlPanel = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-2ec124f3"]]);

export { controlPanel as default };
//# sourceMappingURL=control-panel-B6IfudAz.mjs.map
